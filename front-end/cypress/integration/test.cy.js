...
describe("Create recommendation", () => {
	...
	it("Try to create a new recommendation if name is empty",  () => {
		const recommendations = {
			youtubeLink: "https://www.youtube.com/watch?v=chwyjJbcs1Y",
		};
		cy.visit("http://localhost:3000/");
	...
	it("Try to create a new recommendation if youtube link is empty",  () => {
		const recommendations = {
			name: faker.music.songName(),
		};
		cy.visit("http://localhost:3000/");
...
describe("Downvote a recommendation", () => {
    it("Try to downvote a recommendation",  () => {
        cy.createRecommendation();
        const id = 1;
        cy.intercept("GET", `${URL}/recommendations`).as(
            "getRecommendations"
...
describe("Get recommendations", () => {
    ...
    it("Try to get any recommendations if there are no recommendations",  () => {
        cy.intercept("GET", `${URL}/recommendations`).as(
            "getRecommendations"
        );
        cy.visit("http://localhost:3000/");
